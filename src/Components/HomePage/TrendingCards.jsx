...
const TrendingCards = ({ id, image, name, cuisine, rating, prepTimeMin, caloriesPerServing }) => {
    ...
    const addToCart = () =>{
       const compareExistingProduct = cartItem.find((item)=>{return item.id === id})
       if(compareExistingProduct){
        ...
        <div className='w-[24%] shadow-[0_0_7px_#8080806e] rounded-2xl overflow-hidden '>
            ...
            <div className='px-5 py-4 flex flex-col gap-3'>
                ...
                <div className='flex justify-between'>
                    ...
                    <button className='bg-black rounded-3xl px-3 py-2 text-white text-xs font-bold active:scale-95 transition-transform duration-100' onClick={addToCart}>Add to Cart</button>
                </div>
            </div>
